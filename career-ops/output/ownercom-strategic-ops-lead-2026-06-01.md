...
- Served as Application Stream Lead on the TC Energy / Southbow spinoff — rationalized 2,000+ applications down to fit a 600-person company; recommended migrating from planned AWS and SAP architecture to Azure and Dynamics 365; recommendation accepted and adopted as the platform direction
...
- Built intake and evaluation frameworks for digital transformation initiatives across industrial operations clients — developed prioritization models, business case structures, and go/no-go criteria governing a $14M portfolio of proof-of-concept investments
- Conducted financial modeling (ROI, NPV, cash flow) for all PoC evaluations — worked with Financial Managers to validate that projected value could be realized within departmental budget constraints
- Facilitated alignment between operational stakeholders and technical teams across every engagement — defining pilot objectives, success criteria, and cross-functional ownership before programs launched
...
- Led requirements gathering and future-state process design across work management, reliability, and asset lifecycle — facilitating workshops across Operations, Engineering, Maintenance, Reliability, and IT; designed intake, prioritization, and escalation patterns governing how work moved through each workflow
- Proposed and drove formation of a capability-based EAM team — grew from 3 to approximately 10 people; designed role definitions, team operating model, and accountabilities from scratch
- Designed the enterprise asset and location naming standard governing equipment naming, functional locations, and asset hierarchies — adopted across 26+ facilities and multiple enterprise systems, improving data consistency and cross-system integration

**Team Lead, Maximo Support** | 2012 — 2014

- Designed support intake and prioritization processes, SLA definitions, and escalation paths — built the operating model for how demand entered the function, how work was tracked, and how performance was measured and reported

### Shell Canada Ltd.
**Service Operations Management Analyst** | 2010 — 2013

- Built KPI frameworks and SLA performance reporting from scratch for a service operations function; identified process improvements contributing approximately $90K in annual cost savings and presented findings to leadership to drive change
...
- Stakeholder Alignment (VP / GM / Director / SteerCo)
