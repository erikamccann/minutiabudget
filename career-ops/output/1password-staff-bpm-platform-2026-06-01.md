...
- Led a cross-functional delivery team (Business Analysts, Systems Analysts, Developers) through a period where demand tripled while team capacity dropped from 9 to 4 — maintained delivery quality through backlog prioritization, intake management, and stakeholder alignment
...
- Recommended migrating from the planned AWS and SAP architecture to Azure and Dynamics 365 for the Southbow spinoff; recommendation accepted and became the platform direction for the 600-person company
...
- Designed intake and evaluation frameworks for digital transformation initiatives across industrial operations clients — defining prioritization models, business case structures, and go/no-go criteria for a $14M portfolio of proof-of-concept investments
- Facilitated alignment between operational stakeholders and technology teams — bridging implementation reality and strategic objectives across every engagement, ensuring cross-functional ownership before programs launched
- Assessed API integration patterns, data architecture, and platform interoperability as part of technology evaluation across multiple clients
...
- Led requirements gathering and future-state process design across work management, reliability, and asset lifecycle — facilitating cross-functional workshops across Operations, Engineering, Maintenance, Reliability, and IT; designed intake, prioritization, and escalation patterns for how work moved through each workflow
- Served as business analyst for Maximo platform integrations — defined integration requirements, data flows, and functional specifications for connections between Maximo and enterprise ERP, financial, and operational systems
- Proposed and drove the formation of a capability-based EAM team — grew from 3 to approximately 10 people; designed role definitions, team operating model, and accountabilities from blank page

**Team Lead, Maximo Support** | 2012 — 2014

- Designed support intake and prioritization processes, SLA definitions, and escalation paths — built the operating model for how demand entered the function and how work was tracked and resolved

### Shell Canada Ltd.
**Service Operations Management Analyst** | 2010 — 2013

- Developed KPI frameworks and SLA reporting for a service operations function — built performance measurement from scratch and presented findings to leadership to drive improvement decisions

### Husky Energy
**Software Developer** | 2012

- Designed and developed a GIS job tracking workflow application in C# with a custom SQL database — full end-to-end from requirements through deployment
...
- Executive Stakeholder Alignment (VP / GM / Director)
